...
//
//InmuebleValor por metro cuadrado
//Casa rural$ 1 500000
...
//Oficina$ 3500 000
    ...
    public void pueblaValores() {
        ...
        this.valorUnitario.put("Casa rural", 1500d);
        this.valorUnitario.put("Casa en conjunto cerrado", 2500d);
        this.valorUnitario.put("Casa independiente", 3000d);
        this.valorUnitario.put("Apartamento estudio", 1500d);
        this.valorUnitario.put("Apartamento familiar", 2000d);
        this.valorUnitario.put("Local comercial", 3000d);
        this.valorUnitario.put("Oficina", 3500d);
    ...
    public String toString() {
        return "Inmueble{" + "area=" + area + ", direccion='" + direccion + '\'' + ", idInmo=" + idInmo + ", precioVenta="
                + precioVenta + '}';
    }
}
