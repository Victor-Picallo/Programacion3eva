...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    public VentanaPrincipal() {
        ...
        inicio();
        setTitle("Nomina");  // Comillas rectas
        setSize(280, 380);
    ...
    public void inicio() {
        ...
        menuOpciones = new JMenu("Menu");  // Comillas rectas
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource() == itemMenu3) {
            ...
            //LINEA IMPORTANTE SIN ESTO NO SE MUESTRA EL DIALOGO
            ...
            if (respuesta == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    File archivo = new File(nombre + "\\" + "Nomina.txt");
                    ...
                    bw.write(contenido);
                    bw.close();
                    String texto = "Archivo creado en:\n" + directorioElegido.getAbsolutePath();
                    JOptionPane.showMessageDialog(this, texto, "Exito",
                            JOptionPane.INFORMATION_MESSAGE);
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(this, "Error al guardar", "Error",
